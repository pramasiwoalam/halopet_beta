...
import 'package:halopet_beta/app/modules/order/views/order_cancelled_view.dart';
import 'package:halopet_beta/app/modules/order/views/order_completed_view.dart';
import 'package:halopet_beta/app/modules/order/views/order_ongoing_view.dart';
import 'package:halopet_beta/app/modules/order/views/order_payment_view.dart';
...
class OrderView extends GetView<OrderController> {
  ...
  List<Widget> containerList = [
    ...
    OnGoingUserContainer(),
    CompletedUserContainer(),
    CancelledUserContainer()
  ];
